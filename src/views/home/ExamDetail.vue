      ...
      <div class="right">
        <div class="margin-16">
          <div class="display-flex ai-center jc-space-between">
            ...
            <p class="margin-0">
              <span class="fs-24"  :class="score < 60 ? 'color-info' : 'color-success'">{{score}}</span>分
            </p>
          </div>
          ...
          <div class="display-flex jc-center ai-center">
            ...
            <div class="display-flex ai-center">
              <p class="tip info margin-0"></p>
              <span class="fs-12 color-info ml-10">未做</span>
            </div>
          </div>
          <div class="list">
            <div
              ...
              :style="{backgroundColor: item.form.userAnswer ? '' : '#cccccc'}"
