  ...
  <div class="main">
    ...
    <el-form class="mt-20 width-percent-50" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px">
      <el-form-item label="班次名称" prop="className">
        <el-input placeholder="请输入班次名称" v-model="ruleForm.className"></el-input>
      </el-form-item>
     <el-form-item label="班次开始日期" prop="classStartDate">
      ...
      <el-form-item label="培训单位" prop="repeated">
        <el-select class="width-percent-100" v-model="ruleForm.companyId" placeholder="请选择培训单位">
